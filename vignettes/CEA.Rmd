...
1. Simulation for $\eta$ tuning algorithm, generating Fig 2, Table 1, Fig S2.

2. Simulation for cPCA, generating Fig S1a, Fig S3.

3. Simulation for scPCA, generating Fig S1b.

4. Simulation for robustness of $\eta$ tuning algorithm. Fig S4, Fig S5

5. Simulation for 3CA, generating Fig 3.

6. Simulation for s3CA, generating Fig 4 and Fig S6.

7. Real data application of scPCA generating Fig S8 to Fig S11.

8. Real data application of s3CA generating Fig 5 and Table S1, Fig S7.
...
p_3CA <- ggplot(data = plot_results)+
            ...
            scale_fill_d3()+
            labs(y = "Estimation of the coefficient in (4.1)",x="Analysis")
print(p_3CA)
